<script setup>
import { ref, defineEmits, watchEffect, compile, computed } from 'vue';
    ...
    <div class="form-container">
        ...
        <div v-if="showForm" class="product-form">
            <form @submit.prevent="saveProduct">
                ...
                <input type="text" name="" id="description" v-model="description" required />
                <label for="price">Price</label>
                <input type="number" name="" id="price" v-model="price" required />
                <label for="image">Image</label>
                <input type="text" name="" id="image" v-model="image" required />
